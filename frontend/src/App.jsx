...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Routes>
        {/* Admin Login Route - Must be before admin/* routes */}
        <Route 
          path="/admin/login" 
          element={user && user.role === 'admin' ? <Navigate to="/admin" replace /> : <AdminLoginPage />} 
        />
          ...
          <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
              <Routes>
                ...
                <Route 
                  path="/login" 
                  element={user ? <Navigate to="/" replace /> : <StudentLoginPage />} 
                />
                <Route 
                  path="/register" 
